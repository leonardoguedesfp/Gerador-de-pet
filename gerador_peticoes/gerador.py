...
from .formatacao import detectar_coluna_data, derivar_variaveis
...
def _processar_registro(
    ...
    try:
        registro_completo = derivar_variaveis(registro, cfg.formato_data)
        gerar_peticao(modelo, registro_completo, caminho_saida)
